...
//Account is a subset of the fields of a Presence Builder Account. Presence Builder basically only has account id and sso token specific to it.
type Account struct {
...
func accountIDFromResponse(r *http.Response) (string, error) {
	...
	if res.Data == nil {
		return "", errors.New("Failed to convert response to data")
	}
	return res.Data["msid"], nil
